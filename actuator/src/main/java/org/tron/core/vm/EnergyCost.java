...
//  private final int NEW_ACCT_SUICIDE = 0;
  ...
  private final int STEP = 1;
  /* backwards compatibility, remove eventually */
  private final int SSTORE = 3;
  private final int ZEROSTEP = 0;
  private final int QUICKSTEP = 2;
  private final int FASTESTSTEP = 3;
  private final int FASTSTEP = 5;
  private final int MIDSTEP = 8;
  private final int SLOWSTEP = 1;
  private final int EXTSTEP = 2;
  private final int GENESISENERGYLIMIT = 1;
  private final int MINENERGYLIMIT = 125;
  private final int BALANCE = 2;
  private final int SHA3 = 3;
  private final int SHA3_WORD = 6;
  private final int SLOAD = 5;
  private final int STOP = 0;
  private final int SUICIDE = 0;
  private final int CLEAR_SSTORE = 5;
  private final int SET_SSTORE = 2;
  private final int RESET_SSTORE = 5;
  private final int REFUND_SSTORE = 15;
  private final int CREATE = 32;
  private final int JUMPDEST = 1;
  private final int CREATE_DATA_BYTE = 5;
  private final int CALL = 4;
  private final int STIPEND_CALL = 23;
  private final int VT_CALL = 9;  //value transfer call
  private final int NEW_ACCT_CALL = 25;  //new account call
  private final int MEMORY = 3;
  private final int SUICIDE_REFUND = 24;
  private final int QUAD_COEFF_DIV = 512;
  private final int CREATE_DATA = 2;
  private final int TX_NO_ZERO_DATA = 68;
  private final int TX_ZERO_DATA = 4;
  private final int TRANSACTION = 21;
  private final int TRANSACTION_CREATE_CONTRACT = 53;
  private final int LOG_ENERGY = 375;
  private final int LOG_DATA_ENERGY = 8;
  private final int LOG_TOPIC_ENERGY = 375;
  private final int COPY_ENERGY = 3;
  private final int EXP_ENERGY = 1;
  private final int EXP_BYTE_ENERGY = 1;
  private final int IDENTITY = 15;
  private final int IDENTITY_WORD = 3;
  private final int RIPEMD160 = 6;
  private final int RIPEMD160_WORD = 12;
  private final int SHA256 = 6;
  private final int SHA256_WORD = 12;
  private final int EC_RECOVER = 3;
  private final int EXT_CODE_SIZE = 2;
  private final int EXT_CODE_COPY = 2;
  private final int EXT_CODE_HASH = 4;
  private final int NEW_ACCT_SUICIDE = 0;
